  ...
  return (
    <footer className={`all_icons ${showDock ? "dock-show" : "dock-hide"}`}>
      ...
      <div className="dock-item">
        <img
          onClick={() => openOnly("github")}
          className="icon github"
          src="/doc_icons/github.svg"
        />
        <span className="dock-label">Github</span>
        <div
          className={`dock-dot ${windowState.apps.github !== "closed" ? "active" : ""}`}
        ></div>
      </div>
      ...
      <div className="dock-item">
        <img
          onClick={() => openOnly("note")}
          className="icon note"
          src="/doc_icons/note.svg"
        />
        <span className="dock-label">Notes</span>
        <div
          className={`dock-dot ${windowState.apps.note !== "closed" ? "active" : ""}`}
        ></div>
      </div>
      ...
      <div className="dock-item">
        <img
          onClick={() => openOnly("resume")}
          className="icon pdf"
          src="/doc_icons/pdf.svg"
        />
        <span className="dock-label">Resume</span>
        <div
          className={`dock-dot ${windowState.apps.resume !== "closed" ? "active" : ""}`}
        ></div>
      </div>
      ...
      <div className="dock-item">
        <img
          onClick={() => openOnly("spotify")}
          className="icon spotify"
          src="/doc_icons/spotify.svg"
        />
        <span className="dock-label">Spotify</span>
        <div
          className={`dock-dot ${windowState.apps.spotify !== "closed" ? "active" : ""}`}
        ></div>
      </div>
      ...
      <div className="dock-item">
        <img
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/tushar-rajput-88a837279/",
              "_blank",
            )
          }
          className="icon link"
      ...
      <div className="dock-item">
        ...
        <div
          className={`dock-dot ${windowState.apps.certificates !== "closed" ? "active" : ""}`}
        ></div>
      </div>
      ...
      <div className="dock-item">
        <img
          onClick={() => openOnly("cli")}
          className="icon cli"
          src="/doc_icons/cli.svg"
        />
        <span className="dock-label">Terminal</span>
        <div
          className={`dock-dot ${windowState.apps.cli !== "closed" ? "active" : ""}`}
        ></div>
      </div>
    </footer>
  );
